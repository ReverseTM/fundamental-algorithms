...
fund_alg::logger * buddy_system_allocator::get_logger() const
{
...
{
    return reinterpret_cast<void**>(reinterpret_cast<unsigned char*>(_allocated_memory) + sizeof(size_t) + sizeof(memory*) + sizeof(fund_alg::logger*) + sizeof(memory::allocation_mode));
}
