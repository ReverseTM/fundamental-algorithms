...
size_t sorted_list_allocator::get_allocator_service_block_size() const
{
    return sizeof(size_t) + sizeof(memory*) + sizeof(logger*) + sizeof(memory::allocation_mode) + sizeof(void*);
}

size_t sorted_list_allocator::get_allocated_memory_size() const
{
...
logger * sorted_list_allocator::get_logger() const
{
...
size_t sorted_list_allocator::get_occupied_block_service_block_size() const
{
    return sizeof(size_t);
}

size_t sorted_list_allocator::get_available_block_size(void * current_block) const
{
    return *reinterpret_cast<size_t*>(current_block);
}

size_t sorted_list_allocator::get_occupied_block_size(void * current_block) const
{
...
void * sorted_list_allocator::get_start_allocated_memory_address() const
{
...
void * const sorted_list_allocator::allocate(size_t request_size) const
{
